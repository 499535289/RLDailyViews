...
- (void)configObserver
{
    ...
    //liwei
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onMoviePlayerPlaybackDidFinishNotification) name:MPMoviePlayerPlaybackDidFinishNotification object:nil];
...
//liwei
- (void)onMoviePlayerPlaybackDidFinishNotification{
